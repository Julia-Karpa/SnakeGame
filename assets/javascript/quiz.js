...
questions = [
  [
    "Snakes are cold blooded and must regulate their body temperature externally. True or false?",
    ["False", "True", "", ""],
    1,
  ],
  [
    "About once a month snakes shed their skin. What is this shedding process called?",
    ["Metamorphosis", "Mitosis", "Ecdysis"],
    2,
  ],
  [
    "Which of the following countries has no wild and native snakes?",
    ["United Kingdom", "Greenland", "Germany", "Australia"],
    1,
  ],
  ["Do all snakes lay eggs?", ["No", "Yes"], 0],
  [
    "What are the three species of snake native to the UK?",
    [
      "Grass Snake, Adder and Cobra",
      "Grass Snake, Adder and Anaconda",
      "Grass Snake, Adder and Smooth Snake",
    ],
    2,
  ],
  [
    "Which famous character from Greek Mythology had snakes in place of hair?",
    ["Aphrodite", "Hercules", "Athena", "Medusa"],
    3,
  ],
  ["Are all snakes venomous?", ["No", "Yes"], 0],
  [
    "What is the fear of snakes known as?",
    ["Ichthyophobia", "Snakeophobia", "Ophidiophobia"],
    2,
  ],
  [
    "Most snakes live on land, however, sea snakes also exist. About how many species of snakes live in the Indian and Pacific Oceans?",
    ["20", "10", "200", "70"],
    3,
  ],
];
...
function displayQuestion() {
  ...
  } else document.getElementById("choice2").innerHTML = "";
  ...
  /* remove the question from the array so that it doesn't come up again */
